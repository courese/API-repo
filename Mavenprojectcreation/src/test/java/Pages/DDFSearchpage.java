...
public class DDFSearchpage extends WebDriverCommons {
	WebDriver driver;
	public DDFSearchpage(WebDriver driver)
	{
	...
	{
		Thread.sleep(5000);
		Explicitwaitforelementobeclickable(driver, driver.findElement(By.xpath("//*[@id='fromCity']")));
